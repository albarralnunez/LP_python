...
def main(argv):
    ...
    for activity in act.activities:
        activity['bikeStations'] = findStations(stationsLst, activity['loc']['x'], activity['loc']['y'])
        #activity['TMBStations'] = Transportation(activity['loc']['x'], activity['loc']['y']).TMBStations
